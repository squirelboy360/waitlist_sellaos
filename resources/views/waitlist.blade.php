...
<body>
    <div class="dark:bg-[#111827] flex-1">

    {{-- nav bar --}}
        <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
            {{-- neem ruimt voor niks --}}
        ...
        {{-- intro --}}
        <div class=" tilt-card       container mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                ...
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Pick the right plan for your business and scale when you need to ⚖️</p>
            </div>
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                <!-- Pricing Card -->
                <div class=" rounded p-4 shadow-lg hover:shadow-md hover:shadow-blue-700  flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
